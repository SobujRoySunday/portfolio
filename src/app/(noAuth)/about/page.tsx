...
const page = () => {
  return (
    <main className='w-full flex flex-col justify-center items-center gap-24'>
      {/* Know who I'm */}
      <div className='w-4/5 flex flex-row justify-between items-center min-h-[calc(100vh-44px)]'>
      ...
      <div className='w-4/5 flex flex-col justify-center items-center gap-8'>
        <h1 className='text-6xl font-semibold'>Know what <span className='text-blue-500'>I&apos;M</span> good at</h1>
        <div className='flex flex-wrap gap-4 justify-center items-center'>
          <div className='w-[200px] border-2 border-foreground flex justify-center items-center py-6 hover:scale-105 transition'>
      ...
      <div className='w-4/5 flex flex-col justify-center items-center gap-8'>
        <h1 className='text-6xl font-semibold'>Know what tools <span className='text-blue-500'>I&apos;M</span> using</h1>
        <div className='flex flex-wrap gap-4 justify-center items-center'>
          <div className='w-[200px] border-2 border-foreground flex justify-center items-center py-6 hover:scale-105 transition'>
